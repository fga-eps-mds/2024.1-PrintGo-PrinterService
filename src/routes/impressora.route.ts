...
impressoraRoutes.patch('/:numSerie', requestHandler(ImpressoraController.updateImpressora));
impressoraRoutes.delete('/:numSerie', requestHandler(ImpressoraController.deleteImpressora));
